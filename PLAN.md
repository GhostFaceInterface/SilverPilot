...
Kısıtların esnetilmesi, ons varlığının emekliye ayrılması ve gram hesabının kurulması.
...
Tüm ons fiyat ve gösterge akışlarının otomatik olarak jenerik gram birimlerine indirgenmesi.
...
Sinyal ve duman testlerinin ons bağımlılığından tamamen temizlenmesi.
...
Kullanıcının Telegram'dan sadece yeni Gram hesabını ve gram cinsinden göstergeleri izleyebilmesi.
...
Tüm sistemin doğrulanarak VPS sunucusuna jenerik olarak kurulması.
