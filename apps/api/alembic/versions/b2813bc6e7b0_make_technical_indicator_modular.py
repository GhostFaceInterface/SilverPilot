...
def upgrade() -> None:
    ...
    op.create_unique_constraint('uq_technical_indicators_snapshot_timeframe', 'technical_indicators', ['price_snapshot_id', 'timeframe'])


def downgrade() -> None:
    op.drop_constraint('uq_technical_indicators_snapshot_timeframe', 'technical_indicators', type_='unique')
    op.create_unique_constraint('uq_technical_indicators_timestamp_timeframe', 'technical_indicators', ['bar_timestamp', 'timeframe'])
