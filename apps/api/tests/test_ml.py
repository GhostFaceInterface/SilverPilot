...
from app.ml.inference import extract_live_features, predict_profitability
...
def make_test_client():
    ...
    try:
        ...
        portfolio = Portfolio(
            name="default-paper", initial_cash=Decimal("1000.00"), cash_balance=Decimal("1000.00"), base_currency="USD"
        )
        db.add(portfolio)
        db.commit()
    finally:
